...
class LogController extends MController {
    ...
    public function formNew() {
        $this->data->action = '@curso/log/save';
        $this->render();
    }
    ...
    public function formUpdate() {
        ...
        $this->data->action = '@curso/log/save/' .  $this->data->id;
        $this->render();
    }

    public function formDelete() {
        $log = new Log($this->data->id);
        $ok = '>curso/log/delete/' . $log->getId();
        $cancelar = '>curso/log/formObject/' . $log->getId();
    ...
    public function save() {
            ...
            $log->save();
            $go = '>curso/log/formObject/' . $log->getId();
