...
class UsuarioMap extends \MBusinessModel {
    ...
    public static function ORMMap() {
        ...
        return array(
            ...
            'associations' => array(
                'pessoa' => array('toClass' => '\curso\models\pessoa', 'cardinality' => 'oneToOne' , 'keys' => 'idPessoa:idPessoa'), 
                'setor' => array('toClass' => '\curso\models\setor', 'cardinality' => 'oneToOne' , 'keys' => 'idSetor:idSetor'), 
                'grupos' => array('toClass' => '\curso\models\grupo', 'cardinality' => 'manyToMany' , 'associative' => 'usuario_grupo'), 
            )
        );
    }
